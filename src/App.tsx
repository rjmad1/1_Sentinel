...
function DashboardCommandCenter() {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'workspace' | 'fleet' | 'fleet-analytics' | 'auditor' | 'remediation' | 'forecasting' | 'topology' | 'importer' | 'ai' | 'software' | 'system-status' | 'coming-soon-fleet' | 'coming-soon-correlation' | 'coming-soon-healing' | 'coming-soon-ai-eng' | 'coming-soon-vuln' | 'coming-soon-execution'>('overview');
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', width: '100vw', overflow: 'hidden' }}>
        ...
        <nav className="sidebar-menu" style={{ flex: 1, overflowY: 'auto' }}>
          ...
          {[
            ...
            },
            {
              title: 'Analysis',
              items: [
                { key: 'workspace', label: 'Git Workspaces', icon: <HardDrive size={16} /> },
      ...
      <main className="main-content">
        ...
        <div className="scroll-container">
          {!envDataState && activeTab !== 'importer' && activeTab !== 'system-status' && activeTab !== 'workspace' && !activeTab.startsWith('coming-soon-') ? (
            <EmptyState
